...
<template>
  <nav class="navbar navbar-expand-md bg-light-blue border-bottom border-vue">
    <div class="container gap-2">
      <RouterLink :to="{ name: 'Home' }" class="d-flex align-items-center text-light">
        <img class="navbar-brand" alt="logo"
          src="https://cdn3.iconfinder.com/data/icons/glypho-generic-icons/64/share-512.png" height="45" />
        <b class="fs-5 text-dark">The Network</b>
      </RouterLink>
      <!-- collapse button -->
